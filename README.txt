To get the skeleton running, open a terminal and do the following:
	1. enter the skeleton folder 'cd path/to/skeleton'
	      v^v^ I have miniconda so I just launched the miniconda terminal and installing them one by one
...
it would be nice to have the specifics on what
these packages & the python app DO